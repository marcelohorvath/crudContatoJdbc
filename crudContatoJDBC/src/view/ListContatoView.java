 ...
 * @author Aluno
 */
public class ListContatoView extends javax.swing.JFrame {

    /**
     * Creates new form ListContatoView
     */
    public ListContatoView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListContatoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListContatoView().setVisible(true);
            }
        });
    }
